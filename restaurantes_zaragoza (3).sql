...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2026 a las 18:50:25
...
INSERT INTO `restaurantes` (`id`, `usuario_id`, `nombre`, `descripcion`, `direccion`, `ciudad`, `latitud`, `longitud`, `telefono`, `email_contacto`, `categoria`, `precio_medio`, `aforo_total`, `activo`, `fecha_registro`) VALUES
(1, 31, 'La Bodegón Aragonés', 'Cocina tradicional aragonesa con los mejores vinos de la región.', 'Calle Alfonso I, 14, Zaragoza', 'Zaragoza', 41.64880000, -0.88910000, '976 20 10 01', NULL, 'española', 28.50, 60, 1, '2026-04-08 18:31:37'),
(2, 3, 'La Casa de Ana', 'Restaurante familiar especializado en cocina mediterránea.', 'Paseo de la Independencia, 22, Zaragoza', 'Zaragoza', 41.65120000, -0.88730000, '976 20 10 02', NULL, 'pasta', 22.00, 40, 1, '2026-04-08 18:31:37'),
(3, 4, 'El Rincón Secreto', 'Alta cocina con producto de temporada y bodega selecta.', 'Plaza del Pilar, 3, Zaragoza', 'Zaragoza', 41.65730000, -0.87730000, '976 20 10 03', NULL, 'sushi', 45.00, 30, 1, '2026-04-08 18:31:37'),
(4, 9, 'Chicago', 'Restaurante de buena calidad , donde serviremos comida tradicional de buena calidad', 'Almozara 18', 'Zaragoza', NULL, NULL, '678909876', 'chicago@gmail.com', 'Otras', 20.00, 35, 1, '2026-04-13 20:43:29'),
(5, 10, 'Montessori', 'Comida de colegio de mala calidad', 'Calle Lagasca , 3', 'Zaragoza', NULL, NULL, '676789865', 'Montessori@gmail.com', 'Alta cocina', 15.00, 20, 1, '2026-04-15 00:37:36'),
(6, 10, 'Juanko Pizza', 'Las mejores pizzas italianas', 'Maria Zayas Sotomayor', 'Zaragoza', NULL, NULL, '654786523', '', 'Italiana', 35.00, 50, 1, '2026-04-15 10:11:30'),
(7, 21, 'Taberna del Pilar', 'Tapas y vinos aragoneses junto a la Basílica del Pilar.', 'Plaza del Pilar, 12, Zaragoza', 'Zaragoza', 41.65720000, -0.87800000, '976300107', 'info@tabernapilar.com', 'española', 18.00, 45, 1, '2026-01-10 10:00:00'),
(8, 22, 'Asador El Ebro', 'Carnes y verduras a la brasa a orillas del Ebro.', 'Paseo Echegaray y Caballero, 5, Zaragoza', 'Zaragoza', 41.65200000, -0.88100000, '976300208', 'info@asadorzgz.com', 'española', 38.00, 55, 1, '2026-01-10 10:00:00'),
(9, 23, 'Café Aragón', 'Desayunos, brunchs y cocina de fusión con producto local.', 'Calle Don Jaime I, 33, Zaragoza', 'Zaragoza', 41.65400000, -0.87950000, '976300309', 'info@cafearagon.com', 'fusión', 15.00, 35, 1, '2026-01-10 10:00:00'),
(10, 24, 'Sidrería Zaragozana', 'Sidra natural asturiana y pinchos de txistorra y queso.', 'Calle Predicadores, 8, Zaragoza', 'Zaragoza', 41.65600000, -0.88500000, '976300410', 'info@sidreriazgz.com', 'sidreria', 20.00, 40, 1, '2026-01-10 10:00:00'),
(11, 25, 'Marisquería del Ebro', 'El mejor marisco y pescado fresco del Cantábrico y Mediterráneo.', 'Avenida César Augusto, 19, Zaragoza', 'Zaragoza', 41.65000000, -0.88200000, '976300511', 'info@marisqueriaebro.com', 'mariscos', 50.00, 50, 1, '2026-01-10 10:00:00'),
(12, 26, 'Tacos & Mezcal', 'Auténtica cocina mexicana con tacos, tostadas y mezcales artesanos.', 'Calle San Blas, 22, Zaragoza', 'Zaragoza', 41.65300000, -0.89000000, '976300612', 'info@tacosmexzgz.com', 'mexicana', 22.00, 38, 1, '2026-01-10 10:00:00'),
(13, 27, 'Verde & Sano', 'Restaurante 100% vegano con ingredientes de proximidad.', 'Calle Manifestación, 14, Zaragoza', 'Zaragoza', 41.64900000, -0.88000000, '976300713', 'info@veganzgz.com', 'vegana', 19.00, 30, 1, '2026-01-10 10:00:00'),
(14, 28, 'Yami Sushi & Ramen', 'Cocina japonesa tradicional: sushi, ramen y gyozas.', 'Calle Coso, 55, Zaragoza', 'Zaragoza', 41.65500000, -0.88300000, '976300814', 'info@yamizgz.com', 'japonesa', 28.00, 42, 1, '2026-01-10 10:00:00'),
(15, 29, 'Burger Artesanal Zgz', 'Hamburguesas premium con carne de ternasco y panes de masa madre.', 'Paseo de las Damas, 7, Zaragoza', 'Zaragoza', 41.64750000, -0.87700000, '976300915', 'info@burgeriaartesanal.com', 'americana', 16.00, 48, 1, '2026-01-10 10:00:00'),
(16, 30, 'Bar de Pinchos Baturro', 'Pinchos y montaditos al estilo aragonés, imprescindible.', 'Calle Temple, 3, Zaragoza', 'Zaragoza', 41.65100000, -0.87600000, '976301016', 'info@pinchoszgz.com', 'kebab', 12.00, 30, 1, '2026-01-10 10:00:00');
